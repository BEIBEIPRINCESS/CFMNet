...
class OrientedStandardRoIHead(RotatedStandardRoIHead):
    ...
    def forward_train(self,
        ...
        Args:
            ...
            gt_bboxes (list[Tensor]): list of gt bboxes.
            gt_labels (list[Tensor]): list of gt labels.
            gt_bboxes_ignore (None | list[Tensor]): ignored bboxes.
            gt_masks (None | Tensor): unused, keep None.
    ...
    def _bbox_forward_train(self, x, sampling_results, gt_bboxes, gt_labels, img_metas):
        ...
        Args:
            ...
            gt_bboxes (list[Tensor]): list of gt bboxes.
            gt_labels (list[Tensor]): list of gt labels.
            img_metas (list[dict]): list of image meta info dict.
    ...
    def simple_test_bboxes(self,
        ...
        # Regression can be disabled by the bounding-box head.

...
from geoseg.datasets.loveda_dataset import (
    CLASSES, LoveDATestDataset, LoveDATrainDataset, val_aug,
)
...
weights_name = "unetformer-cfmnet-512crop-ms-epoch30-rep"
...
train_dataset = LoveDATrainDataset(
    transform=train_aug, data_root=f'{data_root}/TrainVal')
val_dataset = LoveDATrainDataset(
    transform=val_aug, mosaic_ratio=0.0, data_root=f'{data_root}/Val')
test_dataset = LoveDATestDataset(data_root=f'{data_root}/Test')

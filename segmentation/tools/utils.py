...
class Lookahead(Optimizer):
    ...
    def __init__(self, optimizer: Optimizer, k: int = 5, alpha: float = 0.5):
        """Initialize Lookahead with a wrapped optimizer."""
    ...
    def update(self, group):
        """Update slow weights for one parameter group."""
    ...
    def update_lookahead(self):
        """Synchronize all Lookahead slow weights."""
        for group in self.param_groups:
            self.update(group)
    ...
    def state_dict(self):
        """Return the optimizer state dictionary."""
    ...
    def load_state_dict(self, state_dict):
        """Load slow and fast optimizer states."""
        slow_state_dict = {
    ...
    def get_from_params(
        ...
        """Build Lookahead from optimizer parameters."""
